...
msg1 db "Enter Number1 : $"  ; Message to prompt user for first number input
msg2 db "Enter Number2 : $"  ; Message to prompt user for second number input
msg3 db "Sum = $"            ; Message to display sum result
